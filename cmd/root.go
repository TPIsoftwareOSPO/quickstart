...
var RootCmd = &cobra.Command{
	...
	Long: `quickstart is a versatile command-line tool designed to simplify the management of complex, multi-process applications or task sequences.
...
A core feature of quickstart is its robust health check mechanism. Each task can be configured with HTTP-based health checks (including JSON response validation via JSONPath) or command-line script-based health checks.
...
quickstart provides a declarative and efficient way to manage your system's components.
	`,
}
